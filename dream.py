...
if __name__ == '__main__':
    try:
        ...
        parser.add_argument('--rand_min', type=int, default=-128, help='Lower bound for an octave when using --octaves "random x"')
        parser.add_argument('--rand_max', type=int, default=127, help='Upper bound for an octave when using --octaves "random x"')
